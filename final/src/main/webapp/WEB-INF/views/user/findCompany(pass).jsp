...
#findpass_area .line-findpass-number {
	height:60px;
}
#findpass_area .line-findpass td:nth-child(1),
#findpass_area .line-findpass-number td:nth-child(1) {
	text-align:left;
	padding-left:7px;
}
#findpass_area .line-findpass td:nth-child(2),
#findpass_area .line-findpass-number td:nth-child(2) {
	padding-left:10px;
	padding-right:10px;
}
...
#findpass_area .line-findpass-number input[type="text"] {
	width:32.5%;
	text-align:center;
	height:40px;
	border-radius:3px 3px 3px 3px;
...
#findpass_area .line-findpass-number td:nth-child(1) span {
	background: #0f4c81;
	height:40px;
	width:155.78px;
		...
		<div id="container">
			<div id="findpass_area">
				...
				<table id="passfind">
					...
					<tr class="line-findpass">
						<td width=170><span>업체명</span></td>
						<td width=500><input type="text" id="txtName"></td>
						<td width=170></td>
					</tr>
					<tr class="line-findpass-number">
						<td><span>사업자번호</span></td>
						<td>
