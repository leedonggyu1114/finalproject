...
public interface AirMapper {
   ...
   // public void passengersInsert(PassengersVO vo);
    public void passengersInsert(@Param("u_id") String u_id,@Param("a_number") String a_number,@Param("a_p_residentRegistration") String a_p_residentRegistration,@Param("a_p_name") String a_p_name,@Param("a_p_gender") String a_p_gender,@Param("a_p_seat") String a_p_seat);
