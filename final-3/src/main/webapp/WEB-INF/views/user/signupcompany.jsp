...
<body>
	<div id="page">
		...
		<table id="nameCheck">
			<tr>
				<td width=150>사업자등록번호</td>
				<td><input type="text" id="businessNumber" name="c_number" placeholder="사업자등록번호">
				<input type="button" id="btncheckNumber" value="중복확인">
				<input type="hidden" id="numberread" value="0"></td>
			</tr>
			<tr>
				<td width=150>아이디</td>
				<td><input type="text" id="id1" size=50 style="height:20px;" name="c_id" placeholder="id">
					<input type="button" id="btnCheck1" value="중복확인">
					<input type="hidden" id="idread1" value="0"></td>
			</tr>
			<tr>
				<td width=150>패스워드</td>
				<td><input type="password" id="pass1" size=50 style="height:20px;" name="c_pass" placeholder="password"></td>
			</tr>
			<tr>
				<td></td>
				<td class="alert alert-success1" id="alert-success1">비밀번호가 일치합니다.</td>
				<td class="alert alert-danger1" id="alert-danger1">비밀번호가 일치하지 않습니다.</td>
				<td><input type="hidden" value="0" id="passread1"></td>
			</tr>
			<tr>
				<td width=150>패스워드 확인</td>
				<td><input type="password" id="passCheck1" size=50 style="height:20px;" placeholder="password"></td>
			</tr>
			<tr>
				<td width=150>회사이름</td>
				<td><input type="text" value="" id="businessNumber" name="c_name" placeholder="company"></td>
			</tr>
			
			<tr>
				<td width=150>회사주소</td>
				<td><input type="text" id="sample6_postcode1" placeholder="우편번호">
					<input type="button" onclick="sample6_execDaumPostcode1()" value="우편번호 찾기"><br>
					<input type="text" id="sample6_address1" placeholder="주소" size=50><br>
				...
				<td><input type="text" id="c_x" name="c_x"></td>
				<td><input type="text" id="c_y" name="c_y"></td>
			</tr>
			
			<tr>
				<td width=150>휴대폰번호</td>
				<td><input type="hidden" id="txtTel" size=50 style="height:20px;" name="c_tel" placeholder="telephone">
			...
			<tr>
				<td width=150>이메일</td>
				<td><input type="text" id="txtEmail1" size="20" style="height:20px;"  placeholder="e-mail" value="">
					@
					<input type="text" id="txtEmailType1" size="20" readOnly>
					
					<select style="height:20px; width:150px;" id="email1">
			...
			<tr>
				<td>회사 이미지</td>
				<td>
				<img src="http://placehold.it/150x120" id="image1" width=200>
				<input type="file" name="file1" style="visibility:hidden;">
				</td>
			</tr>
				
			<tr>
				<td width=150>대표 성명</td>
				<td><input type="text" id="txtName" size=40 style="height:20px;" name="c_ceo" placeholder="name"></td>	
			</tr>
			
			<tr>
				<td width=150>대표 전화번호</td>
				<td><input type="text" id="txtTel" size=50 style="height:20px;" name="c_ceotel" placeholder="telephone">
				</td>
			</tr>
		...
		<div> 지역 :
			<select id="area" name="c_area" style="width:100px;">
				<option>인천</option><option>속초</option><option>충주</option><option>전주</option><option>부산</option>
				<option>여수</option><option>제주</option>
			</select>
		</div>
